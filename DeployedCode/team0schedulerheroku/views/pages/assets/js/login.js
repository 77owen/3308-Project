function openModal() {
  ...
  myInput.onkeyup = function () {
    ...
    var symbols = /[^A-Za-z0-9]/g; // Fill in the regular expression for symbols
...
function enableButton(letter, capital, number, length, match) {
  ...
  var condition = (letter.classList[0] == "valid" && capital.classList[0] == "valid" 
  && number.classList[0] == "valid" && length.classList[0] == "valid" && match.classList[0] == "valid"); // TODO: Replace false with the correct condition
  if (condition) {
